...
//------------------------------------------------------------------------------
    protected function void reset_arrays(virtual simple_uart_switch_bfm bfm);
...
//------------------------------------------------------------------------------
    protected function frame_data_array_t build_test_sequence(virtual simple_uart_switch_bfm bfm);
