class scoreboard;
    ...
    protected logic[7:0] sout0_frames [];
    protected logic[7:0] sout1_frames [];
  
    protected int proper_frame_ok = 0;
    protected int proper_frame_err = 0;
  
    protected int wrong_start_bit_ok = 0;
    protected int wrong_start_bit_err = 0;
  
    protected int wrong_parity_bit_ok = 0;
    protected int wrong_parity_bit_err = 0;
  
    protected int wrong_stop_bit_ok = 0;
    protected int wrong_stop_bit_err = 0;
  
    protected int wrong_start_parity_stop_ok = 0;
    protected int wrong_start_parity_stop_err = 0;
  
    protected int reset_ok = 0;
    protected int reset_err = 0;
  
    local virtual simple_uart_switch_bfm bfm;
