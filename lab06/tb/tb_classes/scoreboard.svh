class scoreboard extends uvm_subscriber #(sout_data_t);
...
//------------------------------------------------------------------------------
  function void write(sout_data_t t);
    command_s cmd;
    cmd.reset_frame_data = {};
    cmd.frame_data = {};
    cmd.exp_sout0_frames = {};
    cmd.exp_sout1_frames = {};
    cmd.test = PROPER_FRAME;
    
    if (!cmd_f.try_get(cmd))
      $fatal(1, "Missing command in self checker");
    
    get_test_result(t, cmd.exp_sout0_frames, cmd.exp_sout1_frames, cmd.test);
